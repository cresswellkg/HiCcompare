...
csl: /Users/mdozmorov/Documents/Work/VCU_work/3D_DNA/HiCcompare/styles.ref/genome-research.csl
bibliography: /Users/mdozmorov/Documents/Work/VCU_work/3D_DNA/HiCcompare/3D_DNA-references.bib
---
...
```{r, results='hide'}
png('figures/s1.png', width = 2500, height = 1500, units = 'px', res = 300)
diffs = hic_loess(unscaled.tab,  Plot = T, Plot.smooth = FALSE)
dev.off()
```

\begin{center} 
\includegraphics[height=220px]{figures/s1.png}
\end{center}
...
png('figures/s2.png', width = 2500, height = 1500, units = 'px', res = 300)
grid.arrange(p1, p2, ncol = 2)
dev.off()
```

\begin{center} 
\includegraphics[height=220px]{figures/s2.png}
\end{center}
...
png('figures/s3.png', width = 2500, height = 1500, units = 'px', res = 300)
grid.arrange(p1, p2, ncol = 2)
dev.off()
```

\begin{center} 
\includegraphics[height=220px]{figures/s3.png}
\end{center}
...
png('figures/s4.png', width = 2500, height = 1500, units = 'px', res = 300)
grid.arrange(p1, p2, ncol = 2)
dev.off()
```

\begin{center} 
\includegraphics[height=220px]{figures/s4.png}
\end{center}
...
png('figures/s5.png', width = 2500, height = 1500, units = 'px', res = 300)
grid.arrange(p1, p2, ncol = 2)
dev.off()
```

\begin{center} 
\includegraphics[height=220px]{figures/s5.png}
\end{center}
...
```{r, results='hide'}
### Chr 1
png('figures/s6.png', width = 2500, height = 1500, units = 'px', res = 300)
hic_loess(replicate.tab, Plot = T, Plot.smooth = FALSE)
dev.off()
```

\begin{center} 
\includegraphics[height=220px]{figures/s6.png}
\end{center}
...
### Chr 1
png('figures/s7.png', width = 2500, height = 1500, units = 'px', res = 300)
hic_loess(chr1.tab,  Plot = T, Plot.smooth = FALSE)
dev.off()
```

\begin{center} 
\includegraphics[height=220px]{figures/s7.png}
\end{center}
...
```{r, results='hide'}
png('figures/s8.png', width = 2500, height = 1500, units = 'px', res = 300)
diffs = hic_loess(chr11.tab, Plot=T, Plot.smooth = FALSE)
dev.off()
```

\begin{center} 
\includegraphics[height=220px]{figures/s8.png}
\end{center}

```{r, results='hide'}
png('figures/s9.png', width = 2500, height = 1500, units = 'px', res = 300)
...
\begin{center} 
\includegraphics[height=220px]{figures/s9.png}
\end{center}
...
p2 = MD.plot2(chromoR.tab$M, chromoR.tab$D, smooth = FALSE) + ggtitle('After Normalization')
png('figures/s10.png', width = 2500, height = 1500, units = 'px', res = 300)
grid.arrange(p1, p2, ncol = 2)
dev.off()
```

\begin{center} 
\includegraphics[height=220px]{figures/s10.png}
\end{center}

```{r, results='hide'}
png('figures/s11.png', width = 2500, height = 1500, units = 'px', res = 300)
...
\begin{center} 
\includegraphics[height=220px]{figures/s11.png}
\end{center}
...
png('figures/s12.png', width = 2500, height = 1500, units = 'px', res = 300)
grid.arrange(p1, p2, ncol = 2)
dev.off()
```

\begin{center} 
\includegraphics[height=220px]{figures/s12.png}
\end{center}

```{r, results='hide'}
png('figures/s13.png', width = 2500, height = 1500, units = 'px', res = 300)
diffs = hic_compare(ice.table, Plot = T, Plot.smooth = FALSE)
dev.off()
```

\begin{center} 
\includegraphics[height=220px]{figures/s13.png}
\end{center}
...
p1 = MD.plot2(tab$M, tab$D, smooth = FALSE) + ggtitle('Before Normalization')
p2 = MD.plot2(kr.table$M, kr.table$D, smooth = FALSE) + ggtitle('After Normalization')
png('figures/s14.png', width = 2500, height = 1500, units = 'px', res = 300)
grid.arrange(p1, p2, ncol = 2)
dev.off()
```

\begin{center} 
\includegraphics[height=220px]{figures/s14.png}
\end{center}

```{r, results='hide'}
png('figures/s15.png', width = 2500, height = 1500, units = 'px', res = 300)
diffs = hic_compare(kr.table, Plot = T,  Plot.smooth = FALSE)
dev.off()
```

\begin{center} 
\includegraphics[height=220px]{figures/s15.png}
\end{center}
...
p1 = MD.plot2(tab$M, tab$D, smooth = FALSE) + ggtitle('Before Normalization')
p2 = MD.plot2(scn.table$M, scn.table$D, smooth = FALSE) + ggtitle('After Normalization')
png('figures/s16.png', width = 2500, height = 1500, units = 'px', res = 300)
grid.arrange(p1, p2, ncol = 2)
dev.off()
```

\begin{center} 
\includegraphics[height=220px]{figures/s16.png}
\end{center}


```{r, results='hide'}
png('figures/s17.png', width = 2500, height = 1500, units = 'px', res = 300)
diffs = hic_compare(scn.table, Plot = T, Plot.smooth = FALSE)
dev.off()
```

\begin{center} 
\includegraphics[height=220px]{figures/s17.png}
\end{center}
...
png('figures/s18.png', width = 2500, height = 1500, units = 'px', res = 300)
grid.arrange(p1, p2, ncol = 2)
dev.off()
```

\begin{center} 
\includegraphics[height=220px]{figures/s18.png}
\end{center}


```{r, results='hide'}
png('figures/s19.png', width = 2500, height = 1500, units = 'px', res = 300)
MD.plot2(chromoR.result$M, chromoR.result$D, p.val = 1, smooth = FALSE)
dev.off()
```

\begin{center} 
\includegraphics[height=220px]{figures/s19.png}
\end{center}

`ChromoR` found `r num.diffs` differences between the two matrices. Compared to `hic_loess` below:

```{r, results='hide'}
png('figures/s20.png', width = 2500, height = 1500, units = 'px', res = 300)
loess.diffs = hic_loess(chr11.unscaled.tab, Plot = T , Plot.smooth = FALSE)
dev.off()
```

\begin{center} 
\includegraphics[height=220px]{figures/s20.png}
\end{center}

```{r, results='hide'}
png('figures/s21.png', width = 2500, height = 1500, units = 'px', res = 300)
...
\begin{center} 
\includegraphics[height=220px]{figures/s21.png}
\end{center}
