...
chr1.primary   <- read.table("../data/primary.chr1.1000000.txt")
chr1.replicate <- read.table("../data/replicate.chr1.1000000.txt")
...
ROC_on_replicate <- function(raw1, raw2, FC, plot.roc = TRUE, plot.MD = TRUE, numChanges = 10, dist = 1, alpha = 0.05, A.quantile = 0.1, 
  ...
  loess.result <- hic_compare(loess.result, Plot = plot.MD, p.method = p.method, adjust.dist = adjust.dist)
  chromoR.result = hic_compare(chromoR.table, Plot = plot.MD, p.method = p.method, adjust.dist = adjust.dist)
  ice.result = hic_compare(ice.table, Plot = plot.MD, p.method = p.method, adjust.dist = adjust.dist)
  kr.result = hic_compare(kr.table, Plot = plot.MD, p.method = p.method, adjust.dist = adjust.dist)
  scn.result = hic_compare(scn.table, Plot = plot.MD, p.method = p.method, adjust.dist = adjust.dist)
  ma.result = hic_compare(ma.table, Plot = plot.MD, p.method = p.method, adjust.dist = adjust.dist)
