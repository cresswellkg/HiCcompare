...
In the FIND paper they tested their method by performing an analysis to find differences between GM12878 and K562 cell lines. We repeated this analysis with HiCcompare and compared our results to FIND. Table 6.1 lists the maximum resolution of each of the datasets from the analysis. Figure 6.1 shows the differences detected between GM12878 and K562 by HiCcompare and FIND. 
...
**Table 6.3. Summary of M and A values for interaction detected by HiCcompare and FIND.**
```{r}
