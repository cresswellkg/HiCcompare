...
The enrichment analysis showed that many of the differential regions contained genes involved in the immune system. Table 2 displays the results of the enrichment analysis. We also found that the enrichment analyses at each resolution were relatively consistent further indicating the strength of HiCcompare at detecting biologically relevant differences. The results of the HiCcompare and FIND gene enrichment analysis both found pathways related to the immune system suggesting that both methods can detect biologically significant differences.

**Table 2. Gene enrichment results for HiCcompare analyses.** KEGG 2016 pathways are displayed from the enrichment analyses of the 1MB, 100KB, and50KB differentially interacting regions.
